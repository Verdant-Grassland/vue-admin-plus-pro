...
export function useElementPlus(app: App) {
  ...
  if (
    import.meta.env.VITE_USE_ALL_ELEMENT_PLUS_STYLE === 'true' &&
    import.meta.env.VITE_USE_ALL_ELEMENT_PLUS_THEME === 'light'
  ) {
    import('element-plus/dist/index.css')
    return
  } else if (
    import.meta.env.VITE_USE_ALL_ELEMENT_PLUS_STYLE === 'true' &&
    import.meta.env.VITE_USE_ALL_ELEMENT_PLUS_THEME === 'dark'
  ) {
